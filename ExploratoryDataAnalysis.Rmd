...
```{r}
# Conclusion: the model does reasonably fit the new test data, using the 90% confidence interval. With the exception of one of the data points, all the new data points do lie within the predicted intervals and follow the same linear relationsip. 
```
